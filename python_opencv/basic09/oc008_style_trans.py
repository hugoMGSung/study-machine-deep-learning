...
src = cv2.imread('./python/data/skateboard.jpg')
seg = segmentation('./python/data/onnx_model/human_segmentation.onnx', src)
stl = style_transfer('./python/data/onnx_model/mosaic.onnx', src)
